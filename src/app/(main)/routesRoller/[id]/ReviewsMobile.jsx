...
const ReviewsMobile = () => {
  ...
  return (
    <div className="m-auto flex gap-6 max-w-[1200px] text-white justify-center mt-5 md:hidden">
      <div className="flex flex-col gap-5 rounded-2xl bg-gradient-to-r from-slate-800 to-slate-600 shadow-[-2px_4px_43px_5px_#029EE963] mx-auto max-w-screen-xl px-6 py-4">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-2 w-full rounded-2xl border-[1px] border-[#58cbe8] p-6">
