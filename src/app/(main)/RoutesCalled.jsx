...
const RoutesCalled = () => {
  return (
    <div className="flex justify-center items-center pb-5 rounded-t-3xl max-w-[909px] sm:max-w-[90%] sm:mx-auto pt-5">
      <div className="flex flex-col w-full gap-5 max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <div className="flex m-auto items-center justify-between gap-5 text-white w-full">
